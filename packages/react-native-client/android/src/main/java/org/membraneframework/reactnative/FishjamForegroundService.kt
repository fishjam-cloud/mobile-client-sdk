...
class FishjamForegroundService : Service() {
  companion object {
    private const val CHANNEL_ID: String = "org.membraneframework.reactnative.ForegroundServiceChannel" // TODO: Move to plugin
  ...
  override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
      startForeground(
        ...
        notification,
        ServiceInfo.FOREGROUND_SERVICE_TYPE_MEDIA_PROJECTION or ServiceInfo.FOREGROUND_SERVICE_TYPE_CAMERA or ServiceInfo.FOREGROUND_SERVICE_TYPE_MICROPHONE
      )
