...
type RequestPermissionMethod<Permission extends PermissionStatus> =
  () => Promise<Permission>;
type GetPermissionMethod<Permission extends PermissionStatus> =
  () => Promise<Permission>;

type PermissionHookMethods<
  Permission extends PermissionStatus,
  Options = never,
> = {
