 ...
 * @param enableCamera Whether to enable the camera service.
 * @param enableMicrophone Whether to enable the microphone service.
 * @param enableScreencast Whether to enable the screencast service.
 */
