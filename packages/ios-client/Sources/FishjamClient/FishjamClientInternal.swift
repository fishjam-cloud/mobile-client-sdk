...
extension FishjamClientInternal: RTCEngineListener {
    ...
    func onConnected(endpointId: String, endpointIdToEndpoint: Dictionary<String, Fishjam_MediaEvents_Server_MediaEvent.Endpoint>, iceServers: [Fishjam_MediaEvents_Server_MediaEvent.IceServer]) {
    ...
    func onSdpAnswer(sdp: String, midToTrackId: Dictionary<String, String>) {
    ...
    func onTracksAdded(endpointId: String, trackIdToTracks: Dictionary<String, Fishjam_MediaEvents_Server_MediaEvent.Track>) {
